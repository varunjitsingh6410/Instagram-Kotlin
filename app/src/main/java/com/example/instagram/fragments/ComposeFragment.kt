...
class ComposeFragment : Fragment() {
    ...
    fun submitPost(description: String, user: ParseUser, photoFile: File)
    {
        ...
        post.saveInBackground{exception ->
            if (exception != null)
            {
                Log.e(MainActivity.TAG, "Error while saving post" + exception.printStackTrace().toString())
                exception.printStackTrace()
            } else {
                Log.i(MainActivity.TAG, "Post was succesfully saved")
                //view.findViewById<EditText>(R.id.etDescription).text.clear()
                etDescription.text.clear()
                Toast.makeText(requireContext(), "Post has been submitted", Toast.LENGTH_SHORT).show()
            }
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == CAPTURE_IMAGE_ACTIVITY_REQUEST_CODE) {
            if (resultCode == AppCompatActivity.RESULT_OK) {
                ...
                //val ivPreview: ImageView = view.findViewById(R.id.ivPicture)
